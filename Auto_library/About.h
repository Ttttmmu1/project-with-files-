...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(26, 212);
			this->button1->Margin = System::Windows::Forms::Padding(4);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(154, 44);
			this->button1->TabIndex = 1;
			this->button1->Text = L"Повідомити";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &About::button1_Click);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(188, 212);
			this->button2->Margin = System::Windows::Forms::Padding(4);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(154, 44);
			...
			this->textBox1->Location = System::Drawing::Point(14, 22);
			this->textBox1->Margin = System::Windows::Forms::Padding(4);
			this->textBox1->Multiline = true;
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(342, 182);
			...
			this->ClientSize = System::Drawing::Size(369, 270);
...
#pragma endregion
	...
	{
		Report^ reportForm = gcnew Report;
		reportForm->Show();
	}
};
}
